...
ChatStartpageClass.prototype.createSingleStartPage = function (lz, ca, cr) {
    ...
    return '<div id="mcontain" style="display:table-cell;width:460px;height:360px;position:absolute;top:50%;left:50%;margin:-180px 0 0 -230px;text-align:center;vertical-align:middle;"><img style="position: absolute; top: 50%; left: 50%; margin-left: -120px; margin-top: -40px; width: 240px;" src="./../images/livezilla.png" id="logo" alt="" width="240" height="auto" border="0"></div>';
