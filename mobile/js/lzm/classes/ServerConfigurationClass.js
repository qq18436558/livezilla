...
ServerConfigurationClass.prototype.addLicenseKey = function () {
    ...
    var purl = DataEngine.getServerUrl('activate.php');
    openLink(purl);
    TaskBarManager.RemoveActiveWindow();
    ...
    lzm_commonDialog.createAlertDialog(licenseHtml, [{ id: 'ok', name: tid('ok') }, { id: 'close', name: tid('cancel') }], true, true, false);
